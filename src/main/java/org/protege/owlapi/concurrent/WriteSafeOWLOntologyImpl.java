...
public class WriteSafeOWLOntologyImpl implements OWLMutableOntology, WriteSafeOWLOntology {
    ...
    public Set<OWLAnnotationAxiom> getAxioms(OWLAnnotationProperty property) {
        readLock.lock();
        try {
            return delegate.getAxioms(property,Imports.EXCLUDED);
        }
        finally {
            readLock.unlock();
        }
    ...
    public Set<OWLClassAxiom> getAxioms(OWLClass cls) {
        readLock.lock();
        try {
            return delegate.getAxioms(cls,Imports.EXCLUDED);
        }
        finally {
            readLock.unlock();
        }
    ...
    public Set<OWLDataPropertyAxiom> getAxioms(OWLDataProperty prop) {
        readLock.lock();
        try {
            return delegate.getAxioms(prop,Imports.EXCLUDED);
        }
        finally {
            readLock.unlock();
        }
    ...
    public Set<OWLDatatypeDefinitionAxiom> getAxioms(OWLDatatype datatype) {
        readLock.lock();
        try {
            return delegate.getAxioms(datatype,Imports.EXCLUDED);
        }
        finally {
            readLock.unlock();
        }
    ...
    public Set<OWLIndividualAxiom> getAxioms(OWLIndividual individual) {
        readLock.lock();
        try {
            return delegate.getAxioms(individual,Imports.EXCLUDED);
        }
        finally {
            readLock.unlock();
        }
    ...
    public Set<OWLAxiom> getAxioms(boolean b) {
        readLock.lock();
        try {
            return delegate.getAxioms(  Imports.fromBoolean(b));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLClassAxiom> getAxioms(OWLClass cls,
        ...
        readLock.lock();
        try {
            return delegate.getAxioms(cls,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLObjectPropertyAxiom>
        ...
        readLock.lock();
        try {
            return delegate.getAxioms(property,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLIndividualAxiom> getAxioms(OWLIndividual individual,
        ...
        readLock.lock();
        try {
            return delegate.getAxioms(individual,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLDatatypeDefinitionAxiom> getAxioms(OWLDatatype datatype,
        ...
        readLock.lock();
        try {
            return delegate.getAxioms(datatype,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
 ...
 OWLObject entity, Imports includeImports,
    ...
    public int getAxiomCount(boolean includeImportsClosure) {
        readLock.lock();
        try {
            return delegate.getAxiomCount(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLLogicalAxiom> getLogicalAxioms(boolean includeImportsClosure) {
        readLock.lock();
        try {
            return delegate.getLogicalAxioms(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public int getLogicalAxiomCount(boolean includeImportsClosure) {
        readLock.lock();
        try {
            return delegate.getLogicalAxiomCount(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public <T extends OWLAxiom> Set<T> getAxioms(AxiomType<T> axiomType,
        ...
        readLock.lock();
        try {
            return delegate.getAxioms(axiomType,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public <T extends OWLAxiom> int getAxiomCount(AxiomType<T> axiomType,
        ...
        readLock.lock();
        try {
            return delegate.getAxiomCount(axiomType,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLClass> getClassesInSignature(boolean includeImportsClosure) {
        readLock.lock();
        try {
            return delegate.getClassesInSignature(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLObjectProperty> getObjectPropertiesInSignature(
        ...
        try {
            return delegate
                    .getObjectPropertiesInSignature(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLDataProperty> getDataPropertiesInSignature(
        ...
        readLock.lock();
        try {
            return delegate.getDataPropertiesInSignature(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLNamedIndividual> getIndividualsInSignature(
        ...
        readLock.lock();
        try {
            return delegate.getIndividualsInSignature(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLAnonymousIndividual> getReferencedAnonymousIndividuals(
        ...
        try {
            return delegate
                    .getReferencedAnonymousIndividuals(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLDatatype> getDatatypesInSignature(
        ...
        readLock.lock();
        try {
            return delegate.getDatatypesInSignature(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLAnnotationProperty> getAnnotationPropertiesInSignature(
        ...
        try {
            return delegate
                    .getAnnotationPropertiesInSignature(  Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public boolean containsObjectPropertyInSignature(IRI owlObjectPropertyIRI,
        ...
        try {
            return delegate.containsObjectPropertyInSignature(
                    owlObjectPropertyIRI,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public boolean containsAnnotationPropertyInSignature(
        ...
        try {
            return delegate.containsAnnotationPropertyInSignature(
                    owlAnnotationPropertyIRI,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public Set<OWLEntity> getEntitiesInSignature(IRI iri,
        ...
        readLock.lock();
        try {
            return delegate.getEntitiesInSignature(iri,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    }
    ...
    public boolean containsReference(OWLEntity entity,
        ...
        readLock.lock();
        try {
            return delegate.containsReference(entity,   Imports.fromBoolean(includeImportsClosure));
        } finally {
            readLock.unlock();
        }
    } 
