...
public class WriteSafeOWLOntologyImpl_TestCase {
    ...
    private WriteSafeOWLOntologyImpl ontology;

    @Before
    public void setUp() throws Exception {
        when(readWriteLock.readLock()).thenReturn(readLock);
        when(readWriteLock.writeLock()).thenReturn(writeLock);
        ontology = spy(new WriteSafeOWLOntologyImpl(delegate));
        ontology.setLocks(readWriteLock);
    }
